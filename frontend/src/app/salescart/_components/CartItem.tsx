...
export default function CartItem({ bookId, quantity, username, title, author, image, price }:CartProps){
    let eachTotal = 0;
    ...
    return(
        <div className="border-b border-b-slate-200">
            <div className="flex items-center hover:bg-gray-100 -mx-8 px-6 py-5">
                ...
                <span className="text-center w-1/5 font-semibold text-sm">${(Math.floor(Number(price)*0.8)).toString()}</span>
